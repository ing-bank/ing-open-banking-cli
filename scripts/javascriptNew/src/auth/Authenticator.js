...
export class Authenticator {
  ...
  async requestAppToken() {
    ...
    const authorization = `Signature keyId="${(this.configuration.isPSD2 ? "SN=" : '') + this.configuration.keyId}",algorithm="rsa-sha256",headers="(request-target) date digest",signature="${signature}"`;
